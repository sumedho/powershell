...
function CallLavaScript ($lava_command)
{
...
$lava_cmd = "lavatest24.lava"
CallLavaScript $lava_cmd

$proc="envis_gui.exe"
#$proc > log.txt
"DATE,HANDLES,WS,VM,COMMITSIZE" >> lavatest24.txt
while($true)
{
    ...
    [string][datetime]::now + "," + [string]$handle + "," + [string]$WS + "," + [string]$VM + "," + [string]$PageFileUsage >> lavatest24.txt
    #sleep -seconds 5
}
